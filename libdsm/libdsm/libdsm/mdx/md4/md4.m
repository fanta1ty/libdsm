 ...
 * F and G are optimized compared to their RFC 1320 definitions, with the optimization for F borrowed from Colin Plumb's MD5 implementation.
 */
 ...
 * The check for little-endian architectures that tolerate unaligned memory accesses is just an optimization.  Nothing will break if it doesn't work.
 */
