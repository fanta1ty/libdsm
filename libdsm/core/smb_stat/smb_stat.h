...
#define SMB_STAT_SIZE         0         //--> smb_stat_get() OP: Get file size
#define SMB_STAT_ALLOC_SIZE   1         //--> smb_stat_get() OP: Get file allocation size (Size on disk)
#define SMB_STAT_ISDIR        2         //--> smb_stat_get() OP: 0 -> not a directory, != 0 -> directory
#define SMB_STAT_CTIME        3         //--> smb_stat_get() OP: Get file creation time
#define SMB_STAT_ATIME        4         //--> smb_stat_get() OP: Get file last access time
#define SMB_STAT_WTIME        5         //--> smb_stat_get() OP: Get file last write time
#define SMB_STAT_MTIME        6         //--> smb_stat_get() OP: Get file last moditification time
 ...
 * (e.g. '\\folder\\file.ext')
 *\returns An opaque smb_stat or NULL in case of error. You need to
 ...
 *\returns An opaque smb_stat or NULL in case of error. You don't own
 ...
 * This function is a getter that allow you to retrieve various
